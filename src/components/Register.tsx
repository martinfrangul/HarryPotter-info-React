...
const Register = () => {
  ...
  const handleError = (errorCode: string) => {
    ...
    switch (errorCode) {
      ...
      default:
        return "There was a problem creating the account, try again later.";
    }
  };
  ...
  return (
    <div className="max-w-lg mx-auto mt-11">
      {errorMessage && (
        <Alert type="error" message={errorMessage} onClose={closeAlert} />
      )}
      <form
        onSubmit={handleSubmit}
        className="max-w-md mx-auto bg-white dark:bg-slate-800 p-5 rounded-xl mt-11"
      >
        <div className="relative z-0 w-full mb-5 group">
          ...
          <label
            ...
            className="flex justify-start peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
          >
            Email address
          </label>
        </div>
